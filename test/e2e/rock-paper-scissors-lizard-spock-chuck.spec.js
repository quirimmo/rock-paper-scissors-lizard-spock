            ...
            it('should display 6 choicesItems clicking on the make choice button', () => {
                startGame.click().then(() => {
                    makeChoice.click().then(() => {
                        ...
                        choicesItemsIcons.count().should.become(12);
                    });
                });
            });
                        ...
                        rockItem.click().then(() => {
                            computerChosenIcon.getAttribute('ng-src').then(chosenValue => {
                                ...
                                if (chosenValue.includes('scissors')) {
                                    ...
                                    mainResultMessage.getText().should.become('YOU LOST!');
                                    contentResultMessage.getText().should.become('Rock has been killed by Chuck Norris');
                                } else {
                                    mainResultMessage.getText().should.become('YOU LOST!');
                        ...
                        if (computer1Choice === computer2Choice) {
                            ...
                            if (computer1Choice.includes('scissors')) {
                                if (computer2Choice.includes('rock')) {
                                    ...
                                    mainResultMessage.getText().should.become('COMPUTER 1 LOST!');
                                    contentResultMessage.getText().should.become('Scissors has been killed by Chuck Norris');
                            ...
                            //  random computer 1 chose paper
                                ...
                                if (computer2Choice.includes('scissors')) {
                                    ...
                                    mainResultMessage.getText().should.become('COMPUTER 1 LOST!');
                                    contentResultMessage.getText().should.become('Paper has been killed by Chuck Norris');
                                } else if (computer2Choice.includes('spock')) {
                                    mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                            ...
                            // random computer 1 chose lizard
                                ...
                                if (computer2Choice.includes('scissors')) {
                                    ...
                                    mainResultMessage.getText().should.become('COMPUTER 1 LOST!');
                                    contentResultMessage.getText().should.become('Lizard has been killed by Chuck Norris');
                                } else if (computer2Choice.includes('spock')) {
                                    mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                            ...
                            // random computer 1 chose spock
                                ...
                                if (computer2Choice.includes('paper')) {
                                    ...
                                    mainResultMessage.getText().should.become('COMPUTER 1 LOST!');
                                    contentResultMessage.getText().should.become('Spock has been killed by Chuck Norris');
                            ...
                            // random computer 1 chose chuck
                                ...
                                if (computer2Choice.includes('paper')) {
                                    mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    contentResultMessage.getText().should.become('Chuck Norris kills Paper');
                                } else if (computer2Choice.includes('lizard')) {
                                    mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    contentResultMessage.getText().should.become('Chuck Norris kills Lizard');
                                } else if (computer2Choice.includes('spock')) {
                                    mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    contentResultMessage.getText().should.become('Chuck Norris kills Spock');
                                } else if (computer2Choice.includes('scissors')) {
                                    mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    contentResultMessage.getText().should.become('Chuck Norris kills Scissors');
                                } else {
                                    mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    contentResultMessage.getText().should.become('Chuck Norris kills Rock');
                                }
                            }
