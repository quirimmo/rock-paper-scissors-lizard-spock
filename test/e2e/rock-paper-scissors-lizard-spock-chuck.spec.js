...
describe('Rock Paper Scissors Lizard Spock Chuck', () => {
    ...
    describe('human vs computer', () => {
        ...
        describe('choicesItems', () => {
            it('should display 6 choicesItems clicking on the make choice button', () => {
                gamePage.startGame.click().then(() => {
                    gamePage.makeChoice.click().then(() => {
                        // double because considering also the mobile ones which will be included in the count
                        // we could easily filter them asking the visible ones but it is actually irrelevant for the test
                        gamePage.choicesItemsIcons.count().should.become(12);
                    });
                });
            });
                    ...
                    gamePage.makeChoice.click().then(() => {
                        gamePage.rockItem.click().then(() => {
                            gamePage.computerChosenIcon.getAttribute('ng-src').then(chosenValue => {
                                ...
                                } else if (chosenValue.includes('chuck')) {
                                    gamePage.mainResultMessage.getText().should.become('YOU LOST!');
                                    gamePage.contentResultMessage.getText().should.become('Rock has been killed by Chuck Norris');
                                } else {
                                    gamePage.mainResultMessage.getText().should.become('YOU LOST!');
                    ...
                    protractor.promise.all(promisesList).then(images => {
                        ...
                        if (computer1Choice === computer2Choice) {
                            ...
                            if (computer1Choice.includes('scissors')) {
                                ...
                                } else if (computer2Choice.includes('chuck')) {
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 LOST!');
                                    gamePage.contentResultMessage.getText().should.become('Scissors has been killed by Chuck Norris');
                            ...
                            //  random computer 1 chose paper
                                ...
                                if (computer2Choice.includes('scissors')) {
                                    ...
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 LOST!');
                                    gamePage.contentResultMessage.getText().should.become('Paper has been killed by Chuck Norris');
                                } else if (computer2Choice.includes('spock')) {
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                            ...
                            // random computer 1 chose lizard
                                ...
                                if (computer2Choice.includes('scissors')) {
                                    ...
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 LOST!');
                                    gamePage.contentResultMessage.getText().should.become('Lizard has been killed by Chuck Norris');
                                } else if (computer2Choice.includes('spock')) {
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                            ...
                            // random computer 1 chose spock
                                ...
                                if (computer2Choice.includes('paper')) {
                                    ...
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 LOST!');
                                    gamePage.contentResultMessage.getText().should.become('Spock has been killed by Chuck Norris');
                            ...
                            // random computer 1 chose chuck
                            else if (computer1Choice.includes('chuck')) {
                                if (computer2Choice.includes('paper')) {
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    gamePage.contentResultMessage.getText().should.become('Chuck Norris kills Paper');
                                } else if (computer2Choice.includes('lizard')) {
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    gamePage.contentResultMessage.getText().should.become('Chuck Norris kills Lizard');
                                } else if (computer2Choice.includes('spock')) {
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    gamePage.contentResultMessage.getText().should.become('Chuck Norris kills Spock');
                                } else if (computer2Choice.includes('scissors')) {
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    gamePage.contentResultMessage.getText().should.become('Chuck Norris kills Scissors');
                                } else {
                                    gamePage.mainResultMessage.getText().should.become('COMPUTER 1 WON!');
                                    gamePage.contentResultMessage.getText().should.become('Chuck Norris kills Rock');
                                }
                            }
