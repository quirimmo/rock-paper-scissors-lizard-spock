describe('RockPaperScissorsLizardSpockController', function() {
    ...
    beforeEach(function() {
        ...
        module(function($provide) {
            $provide.value('gameEngineService', {
                getRockPaperScissorsLizardSpockSubset: function() {},
    ...
    describe('initialization', () => {
        ...
        it('should call the gameEngineService.getRockPaperScissorsLizardSpockSubset', () => {
            spyOn(gameEngineService, 'getRockPaperScissorsLizardSpockSubset').and.callThrough();
            controller.$onInit();
            expect(gameEngineService.getRockPaperScissorsLizardSpockSubset).toHaveBeenCalled();
        });
